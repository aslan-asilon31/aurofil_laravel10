        ...
        <div class="section-popular-travel row justify-content-center">
          ...
          {{-- @foreach ($items as $item)
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div
                class="card-travel text-center d-flex flex-column" style="background-image:  url('{{ Storage::url('public/travelgalleries/').$item->image }}');">
                {{-- {{ $item->galleries->count() ? Storage::url($item->galleries->first()->image) }} --}}
                {{-- <div class="travel-country">{{ $item ->location }}</div>
                <div class="travel-location">JIMBARAN, BALI</div>
                <div class="travel-button mt-auto">
                  <a href="{{route('detail-bali')}}" class="btn btn-travel-details px-4">
                    View Details
                  </a>
                </div>
              </div>
